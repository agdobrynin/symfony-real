...
class PasswordChangeMailer implements PasswordChangeMailerInterface
{
    public const TEMPLATE_HTML_PATTERN = 'micro-post/email/change-password.%s.html.twig';
    public const TEMPLATE_TEXT_PATTERN = 'micro-post/email/change-password.%s.text.twig';
    ...
    public function send(User $user): bool
    {
        ...
        $subject = $this->translator->trans('email.change_password.subject', [], null, $locale);
